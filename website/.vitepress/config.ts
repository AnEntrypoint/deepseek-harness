...
import { landingLink, localeCollections, orderedPages, routeLink, sectionSpec, type DocsPage, type DocsSidebar } from '../docs.ts'
...
/** Guide-module facts: the guide collection and the module links appended to the guide sidebar. */
...
/**
 * Guide-module facts, giving every module label and collection one home
 * shared by the navigation bar and the guide sidebar.
 */
const guideModules: GuideModules = {
  guide: localeCollections[0],
  develop: { label: 'Development', collection: localeCollections[1] },
  reference: { label: 'Reference', collection: localeCollections[2] },
}
