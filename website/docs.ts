 ...
 * canonical source into the site's route tree.
 */
 ...
 */
export const localeCollections: readonly DocsSidebar[] = ['guide', 'develop', 'reference']
...
/**
 * Every sidebar group, in the order it renders.
 *
