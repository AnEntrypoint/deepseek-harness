...
import { resolveLinuxNodePtyAddon } from './build-exe-for-python-sdk-native-pty.js'
...
const ENTRY_BIN = 'node_modules/@freddie/freddie-sdk-jsonrpc-demo/lib/packaged-bin.js'
...
const PYTHON_RUNTIME_DIR = 'python/sdk-runtime/src/freddie_runtime/runtime'
...
function isArch(value) {
  return (ARCHES).includes(value)
}
...
class SingleExeBuild {
   ...
   */
  staging = resolve(root, PYTHON_RUNTIME_DIR, PYTHON_NODE_SUBDIR)
  ...
  async copyRipgrepSidecar(target, product) {
   ...
   * @param products - the product paths returned by {@link pack}.
   */
  async syncToPythonRuntime(products) {
