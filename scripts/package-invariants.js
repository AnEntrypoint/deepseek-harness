...
export function packageInvariantOwners(root) {
...
export function collectPackageInvariantViolations(root) {
  const violations = []
...
function projectReferencesInvariants(root, ownerDir, entryPath) {
...
function isInvariantRegistration(expression) {
...
function hasNamedExport(sourceFile, name) {
