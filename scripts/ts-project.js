...
export const repositoryConfigHost = {
...
function semanticCompilerOptions(options) {
  return {
    ...options,
    noEmit: true,
    composite: false,
...
export class TypeScriptProject {
   ...
   */
  constructor(projectRoot, face = 'host') {
