 ...
 */
export function repositoryCommitHash(root, environment = process.env) {
...
export function resolveClientBuildEnvironment(
  environment,
  profile = environment[CLIENT_BUILD_PROFILE_SELECTOR],
) {
...
function clientArtifactDigest(root) {
...
function parseClientBuildRecord(value) {
