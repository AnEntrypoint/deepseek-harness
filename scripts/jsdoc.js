...
export function parseJsDoc(raw) {
  ...
  for (const line of inner) {
    ...
    if (m) { mode = m[1]; hasMode = true; flushPara(); inTags = true; continue }
 ...
 */
export function reportViolations(gate, violations) {
