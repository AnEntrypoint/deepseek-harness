...
Documentation is English-only. Never create `zh-CN/` or other locale directories for website content.
...
- `sidebar`: reuse an existing sidebar collection unless the information architecture genuinely needs another one.
