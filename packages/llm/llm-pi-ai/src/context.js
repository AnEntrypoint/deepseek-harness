...
/**
 * Convert text-only harness history to a synchronous pi-ai Context, or convert
 * harness history to a pi-ai Context while resolving durable images when
 ...
 * @param attachments - absent selects the synchronous conversion; otherwise the durable byte resolver for image references.
 ...
 * @returns the pi-ai context; synchronous when `attachments` is absent, otherwise a promise.
 */
