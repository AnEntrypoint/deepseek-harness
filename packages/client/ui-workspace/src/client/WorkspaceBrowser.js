...
/** One-shot creation/update helper: `dsh-project-row-item` (Rows.js exports only the class). */
function ProjectRowItem(props) {
  const el = document.createElement('dsh-project-row-item')
  el.setProps(props)
  return el
}

/** One-shot creation/update helper: `dsh-session-node-item` (Rows.js exports only the class). */
function SessionNodeItem(props) {
  const el = document.createElement('dsh-session-node-item')
  el.setProps(props)
  return el
}
...
function ViewOptionsMenu(props) {
  const el = document.createElement('dsh-view-options-menu')
  el.setProps(props)
  return el
}
...
function SessionTree(props) {
  const el = document.createElement('dsh-session-tree')
  el.setProps(props)
  return el
}
...
function FlatList(props) {
  const el = document.createElement('dsh-flat-list')
  el.setProps(props)
  return el
}
...
function SearchResults(props) {
  const el = document.createElement('dsh-search-results')
  el.setProps(props)
  return el
}
...
export function WorkspaceBrowser(props) {
  const el = document.createElement('dsh-workspace-browser')
  el.setProps(props)
  return el
}
