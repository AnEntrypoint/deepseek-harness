...
function renderCatalogDropdown(el, props) {
  const target = el ?? document.createElement('dsh-catalog-dropdown')
  ...
  #render() {
    ...
    if (parentId === undefined) {
      ...
      if (this.#ancestorOrCount === null) {
        this.#ancestorOrCount = document.createElement('dsh-catalog-dropdown')
    ...
    if (openTitle === undefined) {
      if (this.#ownCount === null) {
        this.#ownCount = document.createElement('dsh-catalog-dropdown')
...
export function renderSubagentHeaderLineage(
  ...
  const target = el ?? document.createElement('dsh-subagent-header-lineage')
  target.setProps(props)
  return target
}
