 ...
 */
export function ReferenceIcon({ kind, size = 16, className }: ReferenceIconProps): JSX.Element {
  switch (kind) {
    case 'session':
      return (
        <svg width={String(size)} height={String(size)} class={className} viewBox="0 0 16 16" fill="none" aria-hidden>
          <path
