 ...
 * @property {number} [maxLocations] - Largest number of rendered locations before an omission marker (default 100).
 * @property {number} [maxResultChars] - Largest complete rendered result in characters, including truncation metadata (default 16000).
 * @property {number} [timeoutMs] - Tool-call timeout budget in ms (default 60000).
 */
