/**
 * Package-owned invariant companion for `@freddie/freddie-typert-generator`.
 * @module @freddie/freddie-typert-generator/invariant
 */

/* jscpd:ignore-start */
const PACKAGE_NAME = '@freddie/freddie-typert-generator'
