 ...
 * @module @freddie/freddie-typert-generator/emitter
 */
...
export class FaceModelEmitter {
  ...
  renderJs(
    ...
    const lines = [
      '/* Generated by @freddie/freddie-typert-generator from FaceModel — do not edit. */',
    ]
  ...
  emitRemote(packageModel) {
    ...
    const lines = [
      '/* Generated by @freddie/freddie-typert-generator from the Host FaceModel — do not edit. */',
    ]
    if (schemas.definitions.length > 0) lines.push('import { z } from \'zod\'', '')
    lines.push(...schemas.definitions)
    if (schemas.definitions.length > 0) lines.push('')
  ...
  renderRemoteDts(packageModel) {
    ...
    const lines = [
      ...
      '} from \'@freddie/freddie-typert-protocol\'',
    ]
    ...
    lines.push('')
    lines.push('declare module \'@freddie/freddie-typert-protocol\' {')
...
class SchemaEmitter {
  ...
  declarationDefinition(declaration) {
    ...
    const parameters = declaration.typeParameters.map((parameter, index) =>
      [`type${String(index)}$schema`, parameter.id])
