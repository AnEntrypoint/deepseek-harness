 ...
 * @module @freddie/freddie-code-runtime-python/src/protocol
 */
 ...
 * Projected from the roles below: a TS-side field add, remove, rename, or
 * optionality flip fails typecheck at the roles map, and a Python-side
 * divergence fails the mirror test at runtime.
 */
