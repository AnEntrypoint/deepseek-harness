/**
 * Fresh-process SDK subagent client. Drives one child Freddie
 * runtime over stdio JSON-RPC through `@freddie/freddie-sdk-client` and owns
 * cancellation and quiescent disposal. Structure mirrors the ACP backend
 * (`@freddie/freddie-subagent-acp`): publish after the child handshake,
 ...
 *
 * @module @freddie/freddie-subagent-freddie-sdk/run
 */

import { randomUUID } from 'node:crypto'
import { Freddie } from '@freddie/freddie-sdk-client'
...
/**
 * Map a child turn-end reason to a harness SubagentStopReason.
