 ...
 * @module @freddie/freddie-subagent-freddie-sdk
 */
...
export function apply(ctx, config) {
  ...
  assertPositiveFinite('subagent-freddie-sdk', 'shutdownTimeoutMs', resolved.shutdownTimeoutMs)
  assertPositiveFinite('subagent-freddie-sdk', 'disposeEofGraceMs', resolved.disposeEofGraceMs)
  assertPositiveFinite('subagent-freddie-sdk', 'disposeGraceMs', resolved.disposeGraceMs)
  ...
  const configuredCwd = validateConfiguredCwd('subagent-freddie-sdk', resolved.cwd)
