/**
 * Package-owned invariant companion for `@freddie/freddie-subagent-codex`.
 * @module @freddie/freddie-subagent-codex/invariant
 */

/* jscpd:ignore-start */
const PACKAGE_NAME = '@freddie/freddie-subagent-codex'
