...
export function spawnDialogWorker(data) {
  ...
  return spawn(process.execPath, ['--import', import.meta.resolve('tsx/esm'), fileURLToPath(new URL('./win32-dialog-worker.js', import.meta.url))], { env, stdio, windowsHide: true })
}
