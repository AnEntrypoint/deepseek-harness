...
import freddie_runtime as runtime
import pytest

from freddie_runtime import (
...
def test_default_config_is_shipped_with_the_package() -> None:
    ...
    assert "@freddie/freddie-agent-spine-demo" in config
    assert "@freddie/freddie-session-persistence-jsonl" in config
    assert "@freddie/freddie-session-checkpoint-policy" in config
